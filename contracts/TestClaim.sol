...
contract GOODTYPETestListing is GOODTYPEToken {
  ...
  function claim(uint256 _typeId, uint256 _instanceId, string _data) public {
    uint token = buildTokenId(_typeId, _instanceId);
  ...
  //    _tokenMetadata[token] = _data;
      ...
      _assignNewGood(msg.sender, token, _data);
